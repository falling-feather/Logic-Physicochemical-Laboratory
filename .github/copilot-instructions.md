...
「工科实验室」是一个**纯前端交互式科学学习平台**，面向中国高中生，涵盖数学、物理、化学、算法、生物五大学科，共 **63 个 Canvas 2D 可视化实验**，全面对齐人教版（2019 新课标）高中必修及选择性必修核心知识点。
...
| 文档/文件 | 内容 | 何时阅读 |
|-----------|------|----------|
| `doc/DEVELOPER_GUIDE.md` | **完整开发者文档**（~940 行）：架构、目录结构、63 个实验清单、JS 加载顺序、路由/模块选择器/首页系统、加载屏优化、开发指南、CSS 设计系统、部署、更新日志 | 首次接触项目时通读 |
