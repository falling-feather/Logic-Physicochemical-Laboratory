...
当前 Alembic head：`20260708_0035`（管理端告警 outbox 复核字段；V6.6.32 队列摘要、V6.6.33 批量复核和 V6.6.34 dispatch dry-run 均无新增迁移）。
