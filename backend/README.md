...
>
> **当前基线**：FastAPI + SQLAlchemy + Alembic 0046；SQLite 为安全本地默认，MySQL 为发布目标。V7.4.1 已完成管理 API 用户/权限领域拆分首切片；V6.6.63 后端阶段、真实 MySQL、四服务拓扑、Release 构建/回滚和 15/15 stage gate 已完成。
>
> **最后更新**：2026-07-11
