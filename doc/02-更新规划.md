...
> **制定日期**: 2026-04-13 | **最后更新**: 2026-05-26 | **状态**: v6.0.0 项目层级调整 + 正式更名为「星序 Astra」完成
>
> **📌 文档边界约定**（自 v4.0.4 起）：本文档仅承载 *近期已完成增量*（最近 1-2 个小版本）+ *未来更新规划*。所有历史完成的大版本（≤ v4.0.1）、阶段性实验汇总、完整 Bug 修复履历，请参阅 [`doc/03-发布历史.md`](03-发布历史.md)。两份文档分工：本文件面向"下一步"，`03-发布历史.md` 面向"已沉淀"。
>
> 🪐 **v6.0.0 项目层级调整（2026-05-26）**：项目顶层正式更名为「**星序 Astra**」。原"工科实验室"作为下属的一个**星系**保留；与之并列的还有「**代码空间**」（codespace，目录代号 `codevis/`）。后续将延伸更多"星系"——详见 [§ 未来星系构思](#-未来星系构思v60-新增)。
>
> 📝 **v5.1.4 文档体系中文化重组（2026-05-25）**：原 `UPDATE_PLAN.md` → `02-更新规划.md`；原 4 份只读审视报告合并归档至 [99-历史审视报告归档.md](99-历史审视报告归档.md)。

---

## ★ 当前主线：v6.0.0 项目层级调整（2026-05-26）
...
- **教学价值**：相对当前 63 实验是否带来不可替代的认知体验

### 建议下一步

1. v6.1.x：完成主站品牌过渡的边角打磨（小型 UI 修正 / 移动端适配复测）
