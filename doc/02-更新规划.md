...
| **历史星系** | `historia` | 站内星系 | 中国古代发明 / 世界文明轴 / 重大科学事件时间线 | 用户提出；以 Canvas 时间轴 + 地图 + 文物 3D 模型为主 |
...
2. v6.2.x：选定 1 个站内星系候选（推荐**历史星系**或**宇宙星系**）启动 MVP
