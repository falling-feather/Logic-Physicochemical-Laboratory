...
>
> **当前基线**：V7.4.36 已关闭 R5c。V7.4.32—V7.4.35 的开放式三星系总览、单一全局治理、三角色星序落点、9001 同源入口及启动时预置管理员证明契约均已实现；QA-009 对精确提交 `ef17c7bcc354b4b2a9403c357d23c4f209eb5f35` 使用全新 SQLite、独立账号和真实 Edge 150 完成 12/12 语义、桌面/390×844、7 张截图与同库只读总账，P0/P1/P2 为 0。V7.4.36 已同步文档并归档 FE/UI/OPS/QA 长期组。V7.4.21—V7.4.30 的认证、角色资源、组织治理、实验生命周期、当前构建终验和 target-release-v2/51 项仓库门禁保持有效；用户已把域名与公网 R6 后置，本机结论不替代目标环境证据。
>
