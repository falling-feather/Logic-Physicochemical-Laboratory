...
- **工科实验室**（englab）：数学、物理、化学、算法、生物五大学科 65 个 Canvas 可视化交互实验，全面对齐人教版（2019 新课标）高中必修及选择性必修核心知识点。
...
- 主站 `pages/planets/planets.js` 中通过 `CONFIG.galaxies` 的 `externalUrl: '/codevis/'` 配置跳转
