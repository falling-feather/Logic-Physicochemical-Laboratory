...
> **版本**: v6.4.0 主线状态同步；v6.5 后端化规划已接入文档体系
...
>
> ✅ **当前进度状态（2026-06-30）**：工科试验室保留 5 个二级学科与 88 个交互实验；代码空间继续作为 `/codevis/` 独立子站；未来星系作为正式产品内容保留。已结束赛事提交文档、临时展示导览、编号来源展示、取景点、预检脚本和临时依赖已清理；主线资产版本统一为 `20260630mainV64`。
