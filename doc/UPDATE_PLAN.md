...
| 编号 | 任务             | 说明                             | 状态      |
| ---- | ---------------- | -------------------------------- | --------- |
| E-01 | 实验步骤引导系统 | 首次进入实验时显示操作提示覆盖层 | 🔜 待开发 |
| E-02 | 触控手势优化     | 移动端 pinch-zoom、swipe 返回    | 🔜 待开发 |
| E-03 | 实验数据导出     | 截图/CSV 导出功能                | 🔜 待开发 |
| E-04 | 键盘导航完善     | Tab 切换实验控件、Esc 返回画廊   | 🔜 待开发 |
...
| X-03 | 暗/亮主题切换 | 尊重 `prefers-color-scheme` | 🔜 待开发          |
