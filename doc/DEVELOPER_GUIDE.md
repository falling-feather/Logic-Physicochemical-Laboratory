...
> **版本**: v4.0.4 | **最后更新**: 2026-04-18 | **维护者团队**: EngLab Dev Team
...
**工科实验室**是一个基于 HTML/CSS/JavaScript 的交互式科学学习平台，面向高中阶段学生，涵盖**数学、物理、化学、算法、生物**五大学科，提供 **65 个可视化交互实验**，全面覆盖人教版（2019 新课标）高中必修及选择性必修核心知识点。
