...
- V7.5.x 已启动代码空间、未来星系与通用课程编排收束：代码空间和未来星系分别由隔离工作组完成完整视觉概念与重绘，课程平台组负责三个星系共用的课程分块、分批启用/隐藏、学习进度和代码提交/OJ 契约，QA 继续独立验收。V7.4.37 仍是当前稳定运行基线；V7.5 规划与实际完成状态以 [`doc/02-项目规划.md`](doc/02-项目规划.md) 为准。
