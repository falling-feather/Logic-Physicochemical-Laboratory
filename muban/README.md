...
| 模板 | 适用场景 |
|---|---|
| [README.md](README.md) + [template.html](template.html) | 单个实验页面（控件 + Canvas + 教育面板） |
| [01-工科实验室主页布局.md](01-工科实验室主页布局.md) | 新建"星系"子站的科幻星空首页（粒子 + HUD + 主星 + 卫星） |
| [02-多星系顶层导航.md](02-多星系顶层导航.md) | 顶层多星系选择 + 子层学科行星导航大屏 |
| [03-子站首页布局.md](03-子站首页布局.md) | 独立子站（如代码空间）Hero + 特性卡片网格首页 |
| [04-学科画廊布局.md](04-学科画廊布局.md) | 学科页 Hero + 模块卡片画廊 + 实验视图切换 |
