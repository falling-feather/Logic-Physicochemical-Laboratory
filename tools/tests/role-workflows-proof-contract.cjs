...
assert.match(source, /function assertOrderedPaths/);
assert.match(source, /assertOrderedPaths\(browserEvidence\.loadedStyles, expectation\.styles/);
assert.match(source, /\/pages\/student\/student\.css/);
assert.match(source, /\/pages\/teacher\/teacher-foundation\.css/);
assert.match(source, /\/pages\/teacher\/teacher-workbench\.css/);
assert.match(source, /\/pages\/teacher\/teacher-curriculum\.css/);
