...
assert.match(html, /app-session\.js[\s\S]*page-registry\.js[\s\S]*router\.js[\s\S]*main\.js/);
assert.match(serviceWorker, /page-registry\.js\?v=20260715v7413PageRegistryP1/);
...
assert.match(router, /ModuleSelector\.closeModule\(page, \{ preserveHash: true \}\)/);
assert.match(moduleSelector, /closeModule\(page, options = \{\}\)/);
assert.match(moduleSelector, /if \(!options\.preserveHash\)/);
assert.match(router, /module-selector\.js\?v=20260715v7413PageRegistryP1/);
assert.match(main, /module-selector\.js\?v=20260715v7413PageRegistryP1/);
assert.match(main, /page-registry\.js\?v=20260715v7413PageRegistryP1/);
assert.match(main, /AstraPageRegistry\.galaxyFor\(hash\)/);
assert.match(main, /const ENGLAB_ASSET_VERSION = '20260715v7413PageRegistryP1'/);
