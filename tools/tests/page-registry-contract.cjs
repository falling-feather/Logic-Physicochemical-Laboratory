...
assert.equal(registry.scriptFor('teacher'), 'pages/teacher/teacher.js?v=20260716v7426ModuleSwitchLifecycleP4');
...
assert.match(serviceWorker, /page-registry\.js\?v=20260716v7426ModuleSwitchLifecycleP4/);
...
assert.match(router, /module-selector\.js\?v=20260716v7426ModuleSwitchLifecycleP4/);
...
assert.match(main, /const ENGLAB_ASSET_VERSION = '20260716v7426ModuleSwitchLifecycleP4'/);
