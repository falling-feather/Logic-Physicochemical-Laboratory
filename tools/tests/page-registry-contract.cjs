...
assert.equal(registry.scriptFor('teacher'), 'pages/teacher/teacher.js?v=20260716v7427RoleWorkflowGateP0');
assert.equal(registry.scriptFor('planets'), 'pages/planets/planets.js?v=20260718v7434LocalPreviewP0');
...
assert.match(serviceWorker, /page-registry\.js\?v=20260718v7434LocalPreviewP0/);
