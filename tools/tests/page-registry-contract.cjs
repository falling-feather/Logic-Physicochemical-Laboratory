...
assert.equal(registry.scriptFor('teacher'), 'pages/teacher/teacher.js?v=20260716v7425OrganizationGovernanceP0');
...
assert.match(serviceWorker, /page-registry\.js\?v=20260716v7425OrganizationGovernanceP0/);
...
assert.match(main, /const ENGLAB_ASSET_VERSION = '20260716v7425OrganizationGovernanceP0'/);
