...
assert.equal(registry.galaxyFor('student'), 'astra');
assert.equal(registry.galaxyFor('teacher'), 'astra');
...
assert.equal(registry.scriptFor('teacher'), 'pages/teacher/teacher.js?v=20260719v758TeacherPaginationP0');
...
assert.match(serviceWorker, /page-registry\.js\?v=20260719v758ReleaseAuditP0/);
