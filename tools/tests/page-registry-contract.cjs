...
assert.match(serviceWorker, /page-registry\.js\?v=20260715v7419BiologyModeMountP1/);
...
assert.match(router, /module-selector\.js\?v=20260715v7419BiologyModeMountP1/);
assert.match(main, /module-selector\.js\?v=20260715v7419BiologyModeMountP1/);
assert.match(main, /page-registry\.js\?v=20260715v7419BiologyModeMountP1/);
assert.match(main, /AstraPageRegistry\.galaxyFor\(hash\)/);
assert.match(main, /const ENGLAB_ASSET_VERSION = '20260715v7419BiologyModeMountP1'/);
