...
assert.equal(registry.scriptFor('planets'), 'pages/planets/planets.js?v=20260718v7435QaCloseoutP0');
...
assert.match(serviceWorker, /page-registry\.js\?v=20260718v7435QaCloseoutP0/);
