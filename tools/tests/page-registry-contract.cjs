...
assert.equal(registry.scriptFor('teacher'), 'pages/teacher/teacher.js?v=20260719v75ReviewTeacherPagingP0');
...
assert.match(serviceWorker, /page-registry\.js\?v=20260719v759A11yP0/);
