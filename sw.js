const CACHE_NAME = 'astra-static-v20260709v6650TeacherMvpP1';
const APP_SHELL = [
  './',
  './index.html',
  './shared/js/lucide.min.js?v=20260417d',
  './shared/js/config.js?v=20260709v6650TeacherMvpP1',
  './shared/js/router.js?v=20260709v6650TeacherMvpP1',
  './shared/js/main.js?v=20260709v6650TeacherMvpP1',
  './shared/js/backend-content.js?v=20260709v6650TeacherMvpP1',
  ...
  './shared/css/backend-content.css?v=20260709v6650TeacherMvpP1',
  './shared/css/responsive.css?v=20260704qianduanV70',
  './pages/admin/admin.css?v=20260709v6650TeacherMvpP1',
  './pages/admin/admin.js?v=20260709v6650TeacherMvpP1',
  './pages/teacher/teacher.css?v=20260709v6650TeacherMvpP1',
  './pages/teacher/teacher.js?v=20260709v6650TeacherMvpP1',
